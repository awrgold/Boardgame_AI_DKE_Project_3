...
public class GreedyStrategy implements Strategy{
    ...
    // TEST VERSION
    private HashMap<TestTile, String> bestTilesToPlace(ArrayList<String> colors, TestHand hand){
        HashMap<TestTile, String> pieces = new HashMap<>();
    ...
    private ArrayList<TestAction> possibleTestTilePlacements(TestTile tile, HexagonalGrid grid, String color) {
    ...
    private TestAction randomAction(TestTile tile, HexagonalGrid grid) {
        System.out.println("No good moves, doing random action");
    ...
    public TestAction decideMove(ArrayList<String> colors, TestHand hand, HexagonalGrid grid){
        HashMap<TestTile, String> tiles = bestTilesToPlace(colors, hand);
        ArrayList<Action> bestMoves = new ArrayList<>();
