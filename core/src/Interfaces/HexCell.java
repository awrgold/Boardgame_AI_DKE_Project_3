...
public class HexCell<T extends SatelliteData> implements Hexagon<T> {
     ...
     **/
    HexCell(final GridData gridData, final CubeCoordinate coordinate, final HexagonDataStorage<T> hexagonDataStorage) {
    ...
    public boolean equals(final Object object) {
        ...
        final HexCell hexagon = (HexCell) object;
